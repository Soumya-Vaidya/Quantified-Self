...
export default {
  ...
  methods: {
    getLogs() {
      fetch(`http://127.0.0.1:8000/api/trackers/${this.tracker_id}/logs`, {
        method: "GET",
        headers: {
    ...
    deleteLog(tracker_id, log_id) {
      fetch(`http://127.0.0.1:8000/api/trackers/${tracker_id}/logs/${log_id}`, {
        method: "DELETE",
        headers: {
          Accept: "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    downloadLog(tracker_id) {
      fetch(`http://127.0.0.1:8000/api/trackers/${tracker_id}/download`, {
        method: "POST",
        headers: {
          Accept: "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    createChart(type) {
      fetch(`http://127.0.0.1:8000/api/chart/${this.tracker_id}`, {
        method: "GET",
        headers: {
          Accept: "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
